...
The CADET-Research Data Management toolbox is able to track an version control projects in the form of RDM repositories.
...
To check if all remotes are set correctly, the metadata is consistent and stage all changes within the project and output repository, run the following command in the project repository:
